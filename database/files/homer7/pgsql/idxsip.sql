...
CREATE INDEX IF NOT EXISTS hep_proto_1_default_PartitionName_pnr0000_date ON hep_proto_1_default_PartitionName_pnr0000 ((data_header->'create_date'));
-- name: index-default-ruri_user
CREATE INDEX IF NOT EXISTS hep_proto_1_default_PartitionName_pnr0000_ruri_user ON hep_proto_1_default_PartitionName_pnr0000 ((data_header->'ruri_user'));
-- name: index-default-from_user
CREATE INDEX IF NOT EXISTS hep_proto_1_default_PartitionName_pnr0000_from_user ON hep_proto_1_default_PartitionName_pnr0000 ((data_header->'from_user'));
-- name: index-default-to_user
CREATE INDEX IF NOT EXISTS hep_proto_1_default_PartitionName_pnr0000_to_user ON hep_proto_1_default_PartitionName_pnr0000 ((data_header->'to_user'));
-- name: index-default-pid_user
CREATE INDEX IF NOT EXISTS hep_proto_1_default_PartitionName_pnr0000_pid_user ON hep_proto_1_default_PartitionName_pnr0000 ((data_header->'pid_user'));
-- name: index-default-auth_user
CREATE INDEX IF NOT EXISTS hep_proto_1_default_PartitionName_pnr0000_auth_user ON hep_proto_1_default_PartitionName_pnr0000 ((data_header->'auth_user'));
-- name: index-default-cid
CREATE INDEX IF NOT EXISTS hep_proto_1_default_PartitionName_pnr0000_cid ON hep_proto_1_default_PartitionName_pnr0000 ((data_header->'cid'));
-- name: index-default-method
CREATE INDEX IF NOT EXISTS hep_proto_1_default_PartitionName_pnr0000_method ON hep_proto_1_default_PartitionName_pnr0000 ((data_header->'method'));
-- name: index-default-source_ip
CREATE INDEX IF NOT EXISTS hep_proto_1_default_PartitionName_pnr0000_source_ip ON hep_proto_1_default_PartitionName_pnr0000 ((data_header->'source_ip'));
-- name: index-default-destination_ip
CREATE INDEX IF NOT EXISTS hep_proto_1_default_PartitionName_pnr0000_destination_ip ON hep_proto_1_default_PartitionName_pnr0000 ((data_header->'destination_ip'));
