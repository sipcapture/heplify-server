...
CREATE INDEX IF NOT EXISTS hep_proto_35_report_DayDate_pnr0000_cid ON hep_proto_35_report_DayDate_pnr0000 ((data_header->'cid'));
...
CREATE INDEX IF NOT EXISTS hep_proto_5_rtcp_DayDate_pnr0000_cid ON hep_proto_5_rtcp_DayDate_pnr0000 ((data_header->'cid'));
