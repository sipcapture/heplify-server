...
func init() {
	...
	flag.StringVar(&config.Setting.PromAddr, "ps", "", "Prometheus exposing address")
	flag.StringVar(&config.Setting.PromTargetIP, "pi", "", "Prometheus metric target IP")
	flag.StringVar(&config.Setting.PromTargetName, "pn", "", "Prometheus metric target name")
